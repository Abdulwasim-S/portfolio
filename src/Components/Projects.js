      ...
      <div className="row" style={{ height: "100%", background: "black" }}>
        <div className="col-md-4 " data-aos="fade-up" data-aos-duration="500">
          <div class="card bg-dark">
            ...
            <div class="card-body">
              <h3 class="card-title text-warning">Ecommerce application </h3>
              <p class="card-text">
                MERN stack web app with{" "}
                <i>
                  <b>Redux ToolKit</b>.
                </i>
              </p>
              <div className="btn-row ">
                <a
                  href="https://shopzone-nine.vercel.app/"
        ...
        <div className="col-md-4" data-aos="fade-up" data-aos-duration="500">
          <div class="card bg-dark">
            ...
            <div class="card-body">
              ...
              <div className="btn-row ">
                <a
                  href="https://creative-taiyaki-1dec5a.netlify.app/"
                  class="btn btn-success mb-3"
                  target="_blank"
                  rel="noreferrer"
                >
                ...
                <a
                  href="https://github.com/Abdulwasim-S/Breweries"
                  class="btn btn-success mb-3"
                  target="_blank"
                  rel="noreferrer"
                >
